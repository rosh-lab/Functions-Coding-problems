...
def insertstuddetails(sno,sname,marks,crs="PYTHON",cnt="INDIA"): # Function definition with  positional formal parametre & default arguments and it is always recommed to write default argu  after possitional arguments only
